package com.tanzeem.cart_service.utility;

public class AppConstant {

	public static final String ITEM_ADDED 								= "Item successfully added to cart";
	public static final String ITEM_ALREADY_ADDED 						= "Item already present in cart";
	public static final String ITEM_NOT_FOUND							= "Item cannot be found in cart";
	...
	public static final String TOTAL_CART_AMOUNT						= "Total cart amount is: ";
